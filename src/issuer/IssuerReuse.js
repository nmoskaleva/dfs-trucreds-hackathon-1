...
const credDefId = 'Aa4sRAaxcSB4CqNJgnEUVk:3:CL:325441:latest' // credential definition Id you'll use for issuing credentials - it has to be endorsed on the Sovrin Staging Net
const credentialData = {
	"First Name": "Thomas",
	"Last Name": "Watson",
} // Data you'll issue in a credential. Credential data should be in the following format, NOT between the quotation marks:
// {
...
async function run() {
  ...
  console.log("relationshipDid1 =", relationshipDid)
  ...
  //inviteToDidMap.set(invitationId, relationshipDid) //@bc
...
app.post('/webhook', async (req, res) => {
  ...
  switch (message['@type']) {
    ...
    //   console.log('To learn how relationship-reuse can be used check out "ssi-auth" or "out-of-band" sample apps')
	  ...
	  await wsSend({type:"log", data:"relationship="+message.relationship})
